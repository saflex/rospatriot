        ...
        <div id="content" class="container clearfix">
            <div id="breadcrumb" class="row breadcrumb">
                <div class="" itemprop="breadcrumb">
                    <a href="../../../view/ru/main/" class="homepage-link" title="На главную">Главная</a>
                    <i class="fa fa-angle-right"></i>
                    <span class="page-title">Уникальное предложение к 9 мая</span>
                </div>
            </div>
            <h1 id="page-title" class="large">Уникальное предложение к 9 мая</h1>
                ...
                <div id="bottom_blocks" class="row">
                    ...
                    <div class="col-md-5">
                        <div class="bottom-block not-animated" data-animate="fadeInRight" data-delay="300">
                            <div class="block-logo">
                                <a><i class="swing siz-m fa fa-question blue"></i></a>
                            </div>
                            <div class="block-content">
                                <div class="block-heading-m black">Хотите сделать уникальный подарок к великому празднику?</div>
                    ...
                    <div class="col-md-5">
                        <div class="bottom-block not-animated" data-animate="fadeInLeft " data-delay="300">
                            <div class="block-logo">
                                <i class="swing siz-m fa fa-user-plus blue"></i>
                            </div>
                            <div class="block-content">
                                <div class="block-heading-m black">Подарите своим любимым ветеранам футболку с портретом!</div>
                    ...
                    <div class="col-md-5">
                        <div class="bottom-block not-animated" data-animate="fadeInRight" data-delay="300">
                            <div class="block-logo">
                                <i class="swing siz-m fa fa-file-image-o blue"></i>
                            </div>
                            <div class="block-content">
                                <div class="block-heading-m black">Прикрепите фото и создайте задание в форме снизу</div>
					...
					<div class="col-md-5">
                        <div class="bottom-block not-animated" data-animate="fadeInLeft " data-delay="300">
                            <div class="block-logo">
                                <a><i class="swing siz-m fa fa-gift blue"></i></a>
                            </div>
                            <div class="block-content">
                                <div class="block-heading-m black">Получите незабываемый подарок для ваших любимых!</div>
                                    ...
                                    <div class="col-md-15 bosh-ex"> 
                                        <div id="diz" class="col-md-15 scrolly-area">
                                            <h2 style="margin-top: 0px;">Создать задание</h2> 
                                                ...
                                                <a class="ex-red-help" href="#">Показать требования к фото <i class="fa fa-question-circle red"></i></a></div>

                                            <form id="contactfor" action="<?php echo $_SERVER['PHP_SELF'] ?>"
                                                  method="POST" enctype="multipart/form-data" name="mainForm"><input
                                                    name="form_type" type="hidden" value="contact"><input name="utf8"
                                                                                                          type="hidden"
                                                                                                          value="?">
                                                ...
                                                <ul id="contact-form" class="row list-unstyled">
                                                    <li class="col-md-20">
                                                        <label class="control-label" for="message">Опишите задачу как
                                                            можно подробнее <span
                                                        ...
                                                        <textarea rows="7" class="form-control"
                                                                  ...
                                                                  id="comments"
                                                                  placeholder="Например: хочу нанести фото своего дедушки на футболке черного цвета, прикрепляю фото"
                                                                  class="w100 border"
                                                                  cols="90"><?php if ($_SESSION['sendMailForm']['error']) echo($name = $_SESSION['message']); ?></textarea>
                                                    </li>
                                                    <li class="clearfix"></li>

                                                    <p class="fix-ex">Прикрепите фото бабушки/дедушки</p>

                                                    <div class="mar-lw"><input type="button"
                            ...
                            <select id="address_country_new" class="form-control" name="address[country]"
                                    data-default="">
                                <option value="" data-provinces="[]">-- Укажите желаемый цвет футболки --</option>
                            ...
                            <select id="address_country_new" class="form-control" name="address[country]"
                                    data-default="">
                                <option value="" data-provinces="[]">-- Укажите желаемый размер футболки --</option>
                                ...
                                <option value="white">58-60</option>
                                                    ...
                                                    <li class="col-md-20">
                                                        ...
                                                        <input class="form-control subject"
                                                               ...
                                                               maxlength="64"
                                                               value="<?php if ($_SESSION['sendMailForm']['error']) echo($subject = $_SESSION['email']); ?>"/>
                                                    </li>
                                                    <li class="clearfix"></li>
                                        ...
                                        <div class="group_homebanner hidden-xs">
                                            <div class="home_banners_inner not-animated" data-animate="flipInX"
                                                ...
                                                <div class="home_banners_container">
                                                    <h3 class="sb-title"><i class="fa fa-hand-o-right red"></i> Коллекция 9 мая</h3>

                                                    <div id="home_banners" class="clearfix">
                                                        <div class="banner">
                                                            <p>В категории 9 мая Вы можете подобрать для себя и своих близких уникальные принты, которые 
	                                                            мы подготовили специально для великого праздника - Дня Победы.
                                                            </p>
                                                           
                                                                <a  href="../../../view/ru/shop/mayPage.php"><img
                                                                        class="img-responsive max-www"
                                                                        src="../../../asset/image/ex2.jpg" alt=""></a>
                                                         

                                                           
                                                            <a href="../../../view/ru/shop/mayPage.php">
                                                                <button class="btn2" type="button">
                                                                    Открыть коллекцию 9 мая <i
                                                                        class="fa fa-hand-o-left sizz"></i></button>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
